...
def test_parallel_historical_bars():
    ...
    try:
        ...
        test_symbols = ["AAPL", "MSFT", "GOOGL", "TSLA", "NVDA", "META", "AMZN", "JPM", "BAC", "WMT"]
...
def test_optimized_cross_sectional():
    ...
    try:
        ...
        test_symbols = [
            "AAPL", "MSFT", "GOOGL", "TSLA", "NVDA", "META", "AMZN", "JPM", "BAC", "WMT",
            "XOM", "CVX", "PFE", "JNJ", "UNH", "HD", "DIS", "NFLX", "INTC", "CSCO"
        ]
...
def test_full_cycle_timing():
    ...
    try:
        ...
        test_symbols = [
            "AAPL", "MSFT", "GOOGL", "TSLA", "NVDA", "META", "AMZN", "JPM", "BAC", "WMT",
            "XOM", "CVX", "PFE", "JNJ", "UNH", "HD", "DIS", "NFLX", "INTC", "CSCO",
            "AMD", "QCOM", "TXN", "AVGO", "ORCL", "IBM", "CRM", "ADBE", "PYPL", "SQ",
            "V", "MA", "AXP", "GS", "MS", "C", "USB", "PNC", "TFC", "SCHW"
        ]
        ...
        phase_start = time.time()
        all_bars = data_mgr.get_all_historical_bars(test_symbols[:10], periods=20)  # Sample 10
