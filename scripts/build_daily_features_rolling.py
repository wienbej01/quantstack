#!/usr/bin/env python3
"""Build daily feature store for rolling training: 2023-07 to 2025-09."""
...
def load_gold_universe():
    """Load all symbols from gold data directory."""
    data_root = Path("/home/jacobw/gcs-mount/gold/stocks/1m")
    symbols = [d.name for d in data_root.iterdir() if d.is_dir()]
    return sorted(symbols)


def load_daily_bars(
    symbol, start_date, end_date, data_root="/home/jacobw/gcs-mount/gold/stocks/1m"
):
...
def main():
    logging.info("=" * 80)
    logging.info("BUILDING DAILY FEATURE STORE: 2023-07 to 2025-09")
    logging.info("=" * 80)
    ...
    # Date range: 2023-07-01 to 2025-09-30 (27 months)
