#!/usr/bin/env python3
"""Generate SMB SIP membership for 3 months."""
...
def main():
    ...
    output_dir = Path("run/sip_membership_smb_3months")
    ...
    LOGGER.info("=" * 80)
    LOGGER.info("SMB SIP Selection - 3 MONTHS")
    LOGGER.info("=" * 80)
    ...
    with open(summary_file, "w") as f:
        f.write("SMB SIP 3-Month Summary\n")
        f.write("=" * 80 + "\n\n")
