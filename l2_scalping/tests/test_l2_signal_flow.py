...
from signals.l2_signals import L2SignalGenerator, L2Snapshot as SignalSnapshot
import yaml
...
print(f"  Signal: {signal.signal_type.name}, strength={signal.strength:.2f}, confidence={signal.confidence:.2f}")
