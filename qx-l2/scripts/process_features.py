...
def main():
    ...
    parser.add_argument("--config", default="configs/maximum_l2.yaml", help="Config file")
    parser.add_argument("--date", help="Process specific date (YYYY-MM-DD)")
    parser.add_argument("--all", action="store_true", help="Process all dates with raw data")
