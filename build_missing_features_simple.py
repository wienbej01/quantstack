...
def build_features_for_month(year, month):
    ...
    for i, symbol in enumerate(symbols):
        ...
        try:
            ...
            feature_cols = [
                "timestamp", "symbol", "returns", "return_30min", "volume_ratio", 
                "hour_et", "atr_pct", "rsi_7", "rsi_14"
            ] + [f"ret_{w}bar" for w in [1,2,3,5,10,15,20]] + [f"vol_{w}bar" for w in [1,2,3,5,10,15,20]]
