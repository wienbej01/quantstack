...
def composite_entry_score(obi_1: float, obi_5: float, pressure_k: float, 
                          pressure_mean: float, pressure_std: float) -> float:
...
def thin_book_warning(depth_bid_k: float, depth_ask_k: float,
                      bid_threshold: float, ask_threshold: float) -> bool:
