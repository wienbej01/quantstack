...
from extensions.intraday_ml_models.schemas import ModelMetadata, ModelType, FeatureImportance, PredictionResult
...
class TestBaseMLPolicy:
    ...
    def test_policy_initialization(self, mock_model_metadata):
        ...
        with patch('extensions.intraday_ml_policies.base_ml_policy.MLModelRegistry') as mock_registry_class:
            with patch('extensions.intraday_ml_policies.base_ml_policy.MLPredictor') as mock_predictor_class:
                # Setup mocks
                mock_registry = Mock()
