...
def quick_debug():
    ...
    try:
        ...
        features['vwap_deviation_pct'] = ((features['close'] - features['f__ta__vwap_30']) / features['f__ta__vwap_30']) * 100
        ...
        if below_2pct + above_2pct == 0:
            ...
            print(f"   Consider loosening to 1% or 0.5%")
        ...
        for _, row in sample.iterrows():
            print(f"  {row['ts']}: Close=${row['close']:.2f}, VWAP=${row['f__ta__vwap_30']:.2f}, Dev={row['vwap_deviation_pct']:.2f}%")
